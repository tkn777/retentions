...
*All installation methods require **Python 3.9+** *(tested against Python 3.9-3.15-dev)*. (Python 3.9 is still tested for compatibility, but is end-of-life upstream; Python 3.10+ is recommended for security-sensitive use.)
