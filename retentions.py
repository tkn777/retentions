...
def create_parser() -> ModernStrictArgumentParser:
    ...
    g_flags.add_argument("--folder-mode", type=str, choices=["folder", "youngest-file (default)", "oldest-file", "path=<path>"], metavar="time-src", const="casesensitive", nargs="?", default="youngest-file",
